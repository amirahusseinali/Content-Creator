    ...
    <style>
        * {
        ...
        .hero::before {
            ...
            height: 200%;
            background: 
                conic-gradient(from 0deg at 30% 70%, #ff69b4 0deg, #1e90ff 120deg, #ff69b4 240deg, #1e90ff 360deg);
        ...
        .education { border-left-color: #ff69b4; }
        .healthcare { border-left-color: #1e90ff; }
        .tech { border-left-color: #ff69b4; }
            ...
            <div class="container">
                ...
                <div class="about-content">
                    <div class="about-image">
                        <div class="about-image">
    <img src="https://i.postimg.cc/7h53dmfs/IMG-20240930-080928-137-1.webp" alt="Amira Muhammad Hussein" class="profile-placeholder" />
</div>
                    </div>
...
<div class="campaign-card">
  <div class="campaign-header">
    <div class="campaign-title">Bundles Sales Campaign</div>
    <div class="campaign-client">TET</div>
  </div>
  <div class="campaign-content">
    <p class="campaign-description">
      For TET, I crafted the <strong>Script Writing</strong> and <strong>Sales Content</strong> for their 
      <em>Bundles Campaign</em>, designed to drive <strong>conversions</strong>.  
      The focus was on creating compelling scripts and persuasive messaging that positioned the bundles as a 
      must-have solution for learners.
    </p>
    ...
    <!-- Links Section -->
    <div class="campaign-links">
      <a href=https://www.facebook.com/share/r/1D5p5E85xz/" class="view-link" target="_blank">View Script</a>
      <a href="https://www.facebook.com/reel/1175973863613435" class="view-link" target="_blank">View Campaign</a>
 <a href=https://www.facebook.com/reel/482137267951506" class="view-link" target="_blank">View Script</a>
        ...
        <section id="skills" class="section" style="background: #f8f9fa;">
            <div class="container">
<section id="chatbots" class="section">
  <div class="container">
<section id="chatbots" class="section">
  <div class="container">
    <h2 class="section-title">Chatbot Flows & Automation</h2>
    <p class="about-text">
      Beyond traditional copy, I design <strong>end-to-end chatbot flows</strong> that engage, nurture, and convert.  
      Using platforms like <strong>ManyChat</strong>, I craft conversations that feel human.
    </p>

    <div class="industries-grid">
      <!-- Bot Example 1 -->
      <div class="industry-card">
        <div class="industry-icon" style="background: linear-gradient(45deg, fuchsia, cyan);">
          💬
        </div>
        <h3>Lead Generation Bot</h3>
        <p>Automated flow designed to capture and qualify leads through Messenger.</p>
        <a href="https://bit.ly/4lYKsJP" target="_blank" class="cta-link">View Bot</a>
      </div>
      ...
      <div class="industry-card">
        ...
        <p>A structured FAQ bot that simplifies user journeys and reduces manual responses.</p>
        <a href="https://bit.ly/4lYKsJP" target="_blank" class="cta-link">View Bot</a>
      </div>
    </div>

    <!-- Note Section -->
    <div style="margin-top: 2rem; padding: 1rem 1.5rem; background: #fff4f9; border-left: 4px solid #ff69b4; border-radius: 8px; font-size: 0.95rem; color: #1a1a2e;">
      <strong>💡 Note:</strong> To explore the chatbot flows exactly as they were designed, you'll need to download and open them in <a href="https://www.xmind.net/" target="_blank" style="color:#1e90ff; font-weight:bold;">Xmind</a>.
    </div>
  </div>
</section>
            ...
            <div class="container">
                ...
                <div class="campaigns-grid">
                    <div class="campaign-card" style="max-width: 800px; margin: 0 auto;">
                        ...
                        <div class="campaign-content">
                            <div style="background: #fff0f8; padding: 1.5rem; border-radius: 10px; margin-bottom: 1.5rem; border-left: 4px solid #ff69b4;">
                            ...
                            <div style="background: #f8f4ff; padding: 1.5rem; border-radius: 10px; margin: 1.5rem 0;">
                                <h4 style="color: #ff69b4; margin-bottom: 1rem;">💎 Key Copywriting Elements Used:</h4>
                                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); gap: 1rem;">
                                    <div style="background: white; padding: 1rem; border-radius: 8px; text-align: center; border: 2px solid #ff69b4;">
                            ...
                            <div style="background: #fffbf0; padding: 1.5rem; border-radius: 10px; border: 2px dashed #ff69b4;">
                                <h4 style="color: #ff69b4; margin-bottom: 1rem;">📝 Sample Copy Extract:</h4>
                ...
                <div style="margin-top: 3rem; text-align: center;">
                    <div style="background: linear-gradient(45deg, #ff69b4, #1e90ff); color: white; padding: 2rem; border-radius: 20px; max-width: 600px; margin: 0 auto;">
